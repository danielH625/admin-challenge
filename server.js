...
// Serve static files (optional if you have other assets like CSS)
      ...
      <html lang="en">
        ...
        <body>
          <div class="container">
            ...
            <p class="success">The password is: <strong>CTF{admin_success}</strong></p>
          </div>
        </body>
      </html>
    `);
